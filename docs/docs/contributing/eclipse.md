...
![](https://dotty-china.oss-cn-beijing.aliyuncs.com/images/eclipse/eclipse-import.png "Import Dotty to Eclipse")

On the next window, select the bare minimum configuration to run Dotty. You will need the compiler, library and the 
interfaces.

![](https://dotty-china.oss-cn-beijing.aliyuncs.com/images/eclipse/eclipse-select.png "Import Dotty Projects")
...
![](https://dotty-china.oss-cn-beijing.aliyuncs.com/images/eclipse/eclipse-runconfiguration.png "Import Dotty Projects")
